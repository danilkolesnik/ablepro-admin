...
import { useFlows } from "@/stores/apps/flows";
...
const store = useFlows();

const getFlows = computed(() => {
  return store.getFlows;
});
...
const items = computed(() => getFlows.value);
                          ...
                          <v-row>
                            <v-col md="12" cols="12">
                              <v-row>
                                ...
                                <v-col cols="12">
                                  <v-label class="mb-2"
                                    >Flow ID (Only letters and numbers without spaces or
                                    special characters)
                                  </v-label>
                                  <v-text-field
                                    single-line
