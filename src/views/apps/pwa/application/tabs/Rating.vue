...
const rating = ref(2);
const fiveStarCount = ref(50);
const fourStarCount = ref(30);
const threeStarCount = ref(10);
const twoStarCount = ref(5);
const oneStarCount = ref(5);
const generateReviews = ref(false);
</script>
